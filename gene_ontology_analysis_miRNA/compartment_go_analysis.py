...
def analyze_compartments_with_go(df, databases=["GO_Biological_Process_2021", "GO_Molecular_Function_2021"]):
    ...
    print(f"Compartment A genes: {compartment_A_genes}")
    print(f"Compartment B genes: {compartment_B_genes}")
...
if __name__ == "__main__":
    ...
    file_path = 'GO_results_compartments/compartment_go_analysis.xlsx'
