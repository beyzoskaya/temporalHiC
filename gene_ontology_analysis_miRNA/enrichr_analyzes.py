...
def run_mouse_go_analysis():
    ...
    genes_miRNA = ['1700025G04Rik', '3425401B19Rik', 'STUM', 'Abcg1', 'Abra', 'Abt1', 'Acp1', 'Adora1', 'Aff4', 'Amotl1',
                   'Amph', 'Ankrd28', 'Ankrd33b', 'Aptx', 'Arhgef4', 'Atp13a3', 'Bach2', 'Bcl6', 'CDR1', 'CTNND1', 'Odad1', 
                   'Ccdc88a', 'Ccl21d', 'Cdh12', 'Cdk19', 'Cdk6', 'Celf2', 'Chn1', 'Clcn3', 'Col5a3', 'Colq', 'Cpeb2', 'Cplx2',
                    'Crybg1', 'Ctnnd1', 'Cyp2b13', 'Cyp2b9', 'Cyp7a1', 'Macir', 'Dap', 'Dolpp1', 'Dpp10', 'Dusp23', 'Dyrk1b',
                    'Ebf1', 'Ets1', 'Ewsr1', 'Fam114a1', 'Fam163b', 'Fam171a1', 'LRATD1', 'CIBAR1', 'Fbxl12os', 'Fgf21', 'Fli1',
                    'Flrt1', 'Fzd7', 'G2e3', 'Gabra1', 'Gm16387', 'Gm16485', 'DYNLT2A2', 'Gm7293', 'Gmpr', 'Gng12', 'Gnl1', 'Gpm6a',
                    'Gpr158', 'Gramd2a', 'Hbq1a', 'H4c2', 'Hnrnph1', 'Hnrnpu', 'Ier5l', 'Ikzf2', 'Ing2', 'Inhbb', 'Ino80d', 'Itk', 'Jcad',
                    'Kbtbd3', 'Kcnh7', 'Kctd16', 'Klf7', 'Klhdc8a', 'Klhl20', 'Lin28b', 'Ly96', 'MYB', 'Map3k2', 'Map4k4', 'Mars2', 'Mdm4',
                    'Mmp16', 'Mrrf', 'Mzf1', 'Nlgn1', 'Nlrc3', 'Nmi', 'Nr6a1', 'Nsmf', 'Nxph1', 'Pakap', 'Pappa', 'Peg10', 'Pes1', 'Pfkfb2',
                    'Pfn4', 'Phlpp1', 'Plekhb2', 'Plxdc2', 'Ppp2ca', 'Proz', 'Prx', 'Ptchd4', 'Rbm47', 'Rbpj', 'Rnf152', 'SLY', 'Satb2', 'Scaf8',
                    'Sftpb', 'Skida1', 'Slc2a8', 'Slc8a2', 'Sox4', 'Strn3', 'Tagap1', 'Tbc1d24', 'Tbc1d8', 'Tbp', 'Thnsl1', 'Thsd1', 'Tmem245',
                    'Tmem38b', 'Tpsb2', 'Uap1l1', 'Ube2e3', 'Wdr12', 'Zbtb41', 'Zfp467', 'Zfp607a', 'Zfp648', 'Ppif', 'BLTP3A', 'Ttc33', 'Wdr37',
                    'Ywhaq', 'Trim7', 'Zfp846', 'Zfp292', 'Zbtb20', 'Slc9a6', 'Map3k20', 'Zfp850', 'Plagl1', 'Tbc1d1','Tusc3', 'Zfand5', 'Zfp800',
                    'Pcdhb22', 'Tsc22d2']

    #genes = ['AMACR', 'ABCG2']

    genes_miRNA_downregulated = ['Ube2e3', 'Skida1', 'Trim7', 'Nlgn1', 'Tpsb2', 'Fam163b', 'Bcl6', 'Tusc3', 'Ttc33', 'Zfand5', 'Dolpp1',
                                'Amotl1', 'Thnsl1', 'Map3k20', 'Gmpr', 'Jcad', 'Ptchd4', 'Gpm6a', 'Lin28b', 'Kctd16', 'Gpr158', 'Tmem245',
                                'Tbp', 'Abcg1', 'Fam171a1', 'Itk', 'Flrt1', 'Phlpp1', 'BLTP3A', 'Macir', 'Mdm4', 'Klf7', 'Satb2', 'Tbc1d8',
                                'Zfp846', 'Tbc1d24', 'Dusp23', 'Nlrc3', 'Tsc22d2', 'Mars2', 'G2e3', 'SLY', 'Gnl1', 'Plxdc2', 'Zfp292', 'Fli1',
                                '1700025G04Rik', 'Gramd2a', 'Rbm47', 'Scaf8', '3425401B19Rik', 'CTNND1', 'Sftpb', 'Odad1']
    
    genes_miRNA_stable = ["Aff4", "Pcdhb22", "Clcn3", "Gm16485", "Ikzf2", "Fam114a1", "Zfp467", "Ewsr1", "Nmi", "Cdk6",
                         "Ccdc88a", "Ier5l", "Plagl1", "Ino80d", "MYB", "Inhbb", "Slc2a8", "Colq", "Peg10", "Gabra1", 
                         "Klhdc8a", "Ccl21d", "LRATD1", "Ly96", "Slc9a6", "Gm7293", "Nsmf", "Zfp800", "Map4k4", "Celf2", 
                         "Hnrnph1", "Arhgef4", "Cyp2b9", "Plekhb2", "Pappa", "Ppif", "Pfn4", "Ywhaq", "Kcnh7", "Dyrk1b", 
                         "Mmp16", "Rbpj", "Mrrf", "H4c2", "Gm16387", "Bach2", "Prx", "Sox4", "Pakap", "Ankrd28", "Uap1l1", 
                         "Mzf1", "Zbtb41", "Fbxl12os" ]
    
    genes_miRNA_upregulated = ["Ppp2ca", "Pes1", "Adora1", "Slc8a2", "Amph", "Nr6a1", "DYNLT2A2", "Gng12", "Zfp607a", "CDR1", 
                              "Abt1", "Fgf21", "Cdh12", "Klhl20", "Tbc1d1", "Hnrnpu", "Cplx2", "Nxph1", "Proz", "Ing2", 
                              "Ets1", "STUM", "Col5a3", "Cpeb2", "Ctnnd1", "Rnf152", "Zbtb20", "Thsd1", "Acp1", "Hbq1a", 
                              "Fzd7", "Ebf1", "Tmem38b", "Cdk19", "Atp13a3", "Strn3", "Dap", "Wdr37", "Zfp850", "Chn1", 
                              "Aptx", "Ankrd33b", "Dpp10", "Crybg1", "Tagap1", "Pfkfb2", "Cyp2b13", "Zfp648", "Cyp7a1", 
                              "Kbtbd3", "Wdr12", "Abra", "CIBAR1", "Map3k2"]
