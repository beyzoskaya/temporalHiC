...
class TemporalNode2Vec:
    def __init__(self, dimensions=256, walk_length=80, num_walks=10, p=1.0, q=1.0, workers=1, seed=42, temporal_weight=0.5): # temporal_weight 0.5 gave the best correlation value (from 0.6 it gets more overfit!!!)
