...
def calculate_insulation_score(hic_matrix, window_size=5):
    ...
    try:
        ...
        #if np.sum(window) > 0: # less strict condition for miRNA
...
if __name__ == "__main__":
    input_file = "mapped/miRNA_expression_mean/complete_genome_mapping_miRNA_expression_meaned_get_closest.csv"
    output_file = "mapped/miRNA_expression_mean/enhanced_interactions_miRNA_expression_meaned_get_closest.csv"
